  ...
  useEffect(() => {
    ...
    tl.to(".hero-text", {
      ...
      .to(
        ...
        "-=0.5"
      ) // Overlap the image animation slightly
      .to(
        ".hero-button",
        {
          opacity: 1,
        ...
        "-=0.5"
      ); // Delay overlap for smooth effect
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <main className="container mx-auto p-0">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center text-center">
              <div className="md:w-3/6 m-24 mb-8 md:mb-0">
                <h1 className="hero-text font-heading text-white font-bold text-4xl md:text-5xl lg:text-8xl mb-6 leading-tight">
                  ...
                  <span className="text-purple-200">Personal Data</span> Online
                </h1>
                ...
                <a
                  href="#features"
                  className="hero-button bg-white text-purple-700 font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out hover:bg-purple-100 hover:scale-105 transform"
                >
                  Explore Features
                </a>
              </div>
        ...
        {/* Feature Section */}
        <section className="bg-white rounded-3xl shadow-2x ">
          <div className=" h-screen md:p-12">
            <div className="text-center">
              ...
              <p className="font-sans text-purple-800 text-lg mb-8 max-w-2xl mx-auto">
                Learn about the latest techniques and tools to safeguard your
            ...
            <div id="features" className="flex space-x-24 pt-20 h-auto">
              ...
              <div>
                <h3 className="font-heading text-purple-800 font-bold text-3xl md:text-2xl lg:text-4xl mb-6">
                  Companies having your Data and Data Breaches
                </h3>
              </div>
            </div>
            <div id="features" className="flex space-x-24 pt-20">
              <img src="/2.png" alt="" width={100} height={100} />
              <div>
                <h3 className="font-heading text-purple-800 font-bold text-3xl md:text-2xl lg:text-4xl mb-6">
                  Privacy Management using Extensions
                </h3>
              </div>
            </div>
            <div id="features" className="flex space-x-24 pt-20">
        ...
        {/* Info Section */}
        <section className="mt-32 bg-gradient-to-br from-indigo-100 to-purple-200 rounded-3xl shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <p className="font-sans text-purple-700 text-lg mb-8">
                  Get the latest updates on data protection laws, cybersecurity
                  threats, and best practices for maintaining your digital
                  privacy.
                </p>
